...
function YearInput(props) {
  ...
  var onYearChange = function onYearChange(event, data) {
    _.invoke(props, 'onChange', event, _extends({}, props, { value: data.value }));
  };
  ...
  var inputElement = _react2.default.createElement(_semanticUiReact.Input, _extends({}, rest, {
    ...
    onChange: onChange }));
  if (inline) {
    return _react2.default.createElement(_containers.YearPicker, { onYearChange: onYearChange });
  }
